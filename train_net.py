...
from diffusionwyk import (
    DiffusionWYKDatasetMapper,
    add_diffusionwyk_config,
    DiffusionDetWithTTA,
)
from diffusionwyk.util.model_ema import (
...
class Trainer(DefaultTrainer):
    """Extension of the Trainer class adapted to DiffusionWYK."""
    ...
    def build_train_loader(cls, cfg):
        mapper = DiffusionWYKDatasetMapper(cfg, is_train=True)
        return build_detection_train_loader(cfg, mapper=mapper)

    @classmethod
    def build_test_loader(cls, cfg, dataset_name):
        mapper = DiffusionWYKDatasetMapper(cfg, is_train=False)
